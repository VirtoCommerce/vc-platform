...
namespace CommerceFoundation.UI.FunctionalTests.Catalogs
{
	...
	public class CatalogViewModelScenarios : FunctionalUITestBase
	{
		...
		public void Can_add_update_delete_item_property_values()
		{
			...
			var itemViewModel = new ItemViewModel(repositoryFactory, pricelistRepositoryFactory, propertyValueVmFactory, priceVmFactory, assetVmFactory, associationGroupEditVmFactory, associationGroupVmFactory, itemRelationVmFactory, reviewVmFactory, categoryVmFactory, entityFactory, item, authContext, navManager);
