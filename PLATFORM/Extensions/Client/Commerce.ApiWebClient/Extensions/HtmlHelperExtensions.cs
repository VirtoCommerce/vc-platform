...
namespace VirtoCommerce.ApiWebClient.Extensions
{
    ...
    public static class HtmlHelperExtensions
    {
		...
		public static MvcHtmlString Version(this HtmlHelper html)
		{
		    ...
		    if (html.ViewContext.Controller != null)
		    {
		        assembly = html.ViewContext.Controller.GetType().Assembly;
		    }
		    return Version(html, assembly);
		}

        public static MvcHtmlString Version(this HtmlHelper html, Assembly assembly)
        {
            if (_version == null)
            {
