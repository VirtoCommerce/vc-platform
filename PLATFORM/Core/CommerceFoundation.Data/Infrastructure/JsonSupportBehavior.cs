...
{
    public class JsonSupportInspector : IDispatchMessageInspector
    {
        ...
        public void BeforeSendReply(ref Message reply, object correlationState)
        {
            if (correlationState != null && correlationState is string)
            {
                ...
                string content = JsonSupportInspector.encoding.GetString(reader.ReadContentAsBase64());
                if (bodyIsText)
                {
        ...
        class Writer : BodyWriter
        {
            ...
            protected override void OnWriteBodyContents(XmlDictionaryWriter writer)
            {
                ...
                byte[] buffer = JsonSupportInspector.encoding.GetBytes(this.content);
    ...
    public class JsonSupportBehaviorAttribute : Attribute, IServiceBehavior
    {
        ...
        void IServiceBehavior.ApplyDispatchBehavior(ServiceDescription serviceDescription, ServiceHostBase serviceHostBase)
        {
            foreach (ChannelDispatcher cd in serviceHostBase.ChannelDispatchers)
            {
                ...
                {
                    ed.DispatchRuntime.MessageInspectors.Add(new JsonSupportInspector());
                }
            }
        }
