...
namespace PaymentMethods.Tests
{
    ...
    public class KlarnaCheckoutEuroTests
    {
        ...
        private CustomerOrderServiceImpl GetCustomerOrderService()
        {
            ...
            var orderService = new CustomerOrderServiceImpl(orderRepositoryFactory, new TimeBasedNumberGeneratorImpl(), orderEventPublisher, cartService, GetItemService(), dynamicPropertyService, settingManager, null, null, null);
            return orderService;
        }
