...
namespace VirtoCommerce.MarketingModule.Web.Controllers.Api
{
    ...
    public class MarketingModuleDynamicContentController : ApiController
    {
        ...
        public MarketingModuleDynamicContentController(IDynamicContentService dynamicContentService, IMarketingExtensionManager marketingExtensionManager, IMarketingDynamicContentEvaluator dynamicContentEvaluator)
        {
