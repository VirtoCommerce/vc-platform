...
.controller('virtoCommerce.storeModule.storeLanguagesListController', ['$scope', 'settings', 'bladeNavigationService', 'dialogService', function ($scope, settings, bladeNavigationService, dialogService) {
