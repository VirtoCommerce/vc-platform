...
using System.IO;
using NuGet;
using OptimizedZipPackage = VirtoCommerce.Platform.Data.Packaging.Repositories.NuGet.OptimizedZipPackage;

namespace VirtoCommerce.Platform.Data.Packaging.Repositories
{
