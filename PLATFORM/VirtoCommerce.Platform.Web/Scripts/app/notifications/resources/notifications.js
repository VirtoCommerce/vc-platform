...
.factory('platformWebApp.notifications', ['$resource', function ($resource) {
    ...
    return $resource('api/platform/notification/:id', { id: '@Id' }, {
        ...
        prepareTestData: { method: 'GET', url: 'api/platform/notification/template/:type/preparetestdata', isArray: true },
        resolveNotification: { method: 'POST', url: 'api/platform/notification/template/:type/:objectId/:objectTypeId/:language/resolvenotification' },
