...
* [What's new in NET10](https://learn.microsoft.com/en-us/dotnet/core/whats-new/dotnet-10)
* [What's new in EF 10 Core](https://learn.microsoft.com/en-us/ef/core/what-is-new/ef-core-10.0/whatsnew)
* [What's new in ASP.NET Core 10](https://learn.microsoft.com/en-us/aspnet/core/release-notes/aspnetcore-10.0?view=aspnetcore-8.0)

## Benefits

### 1. Enhanced Performance

The upgrade to .NET 10 brings substantial improvements in performance, resulting in faster response times and optimized resource utilization. This ensures a smoother and more efficient e-commerce experience for both customers and administrators.
...
With the transition to .NET 10, bulk operations such as select, update, and delete are optimized for efficiency. This improvement is particularly beneficial for scenarios involving large datasets, providing a noticeable boost in processing speed and resource efficiency.
...
![step2 run ps1 script result](../../media/updatenet10-step2-ps1-script-result.png)
...
![step3 review modified files](../../media/updatenet10-step3-modified-files.png)
...
With the update process completed, you can now run and enjoy the enhanced capabilities of Virto Commerce on the .NET 10 platform. Explore the platform's new features and optimizations to leverage its full potential for a resilient and efficient e-commerce solution.
