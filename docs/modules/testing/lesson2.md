...
![Сsv example](assets/csv-example.png "Сsv example")
...
![Create new category](assets/new-category.png "Create new category")


![New category details](assets/new-category-details.png "New category details")
...
![New folder for images](assets/assets-new-folder.png "New folder for images")


![Upload new images](assets/assets-upload-image.png "Upload new images")
...
![New images list](assets/assets-new-products.png "New images list")
...
![Сsv import](assets/csv-import.png "Сsv import")
...
![Сsv import mapping](assets/csv-import-mapping.png "Сsv import mapping")

![Сsv import mapping done](assets/csv-import-mapping-done.png "Сsv import mapping done")
...
![Сsv import result](assets/csv-import-result.png "Сsv import result")
...
![New category link](assets/new-category-link.png "New category link")

![Pick selected category](assets/pick-selected-category.png "Pick selected category")
...
![New subcategory link](assets/new-subcategory-link.png "New subcategory link")
...
![New thumbnail task](assets/new-thumbnail-task.png "New thumbnails generation task")
...
![New thumbnail options](assets/add-thumbnail-settings.png "New thumbnail options")
...
![New thumbnails was generated](assets/new-thumbnails-generated.png "New thumbnails were generated")
...
![Build search indexes](assets/build-search-indexes.png "Build search indexes")
...
![Reset cache](assets/reset-cache.png "Reset cache")
...
![Laptops on storefront](assets/laptops-on-storefront.png "Laptops on storefront")
...
![Custom property add](assets/custom-property-add.png "Custom property add")

![Custom property details](assets/custom-property-details.png "Custom property details")

![Custom properties list](assets/custom-properties-list.png "Custom properties list")
