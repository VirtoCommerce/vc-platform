...
namespace VirtoCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public class VirtoCommerceMerchandisingModuleWebModelProductVariation : IEquatable<VirtoCommerceMerchandisingModuleWebModelProductVariation>
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VirtoCommerceMerchandisingModuleWebModelProductVariation {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as VirtoCommerceMerchandisingModuleWebModelProductVariation);
        }

        /// <summary>
        /// Returns true if VirtoCommerceMerchandisingModuleWebModelProductVariation instances are equal
        /// </summary>
        /// <param name="obj">Instance of VirtoCommerceMerchandisingModuleWebModelProductVariation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VirtoCommerceMerchandisingModuleWebModelProductVariation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
