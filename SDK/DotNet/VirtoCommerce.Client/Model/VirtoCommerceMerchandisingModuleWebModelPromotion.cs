...
namespace VirtoCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public class VirtoCommerceMerchandisingModuleWebModelPromotion : IEquatable<VirtoCommerceMerchandisingModuleWebModelPromotion>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as VirtoCommerceMerchandisingModuleWebModelPromotion);
        }

        /// <summary>
        /// Returns true if VirtoCommerceMerchandisingModuleWebModelPromotion instances are equal
        /// </summary>
        /// <param name="obj">Instance of VirtoCommerceMerchandisingModuleWebModelPromotion to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VirtoCommerceMerchandisingModuleWebModelPromotion other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.MaxUsageCount != null)
                    hash = hash * 57 + this.MaxUsageCount.GetHashCode();
                
                if (this.MaxPersonalUsageCount != null)
                    hash = hash * 57 + this.MaxPersonalUsageCount.GetHashCode();
                
                if (this.Coupons != null)
                    hash = hash * 57 + this.Coupons.GetHashCode();
