...
namespace VirtoCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public class VirtoCommerceMerchandisingModuleWebModelPromotionReward : IEquatable<VirtoCommerceMerchandisingModuleWebModelPromotionReward>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as VirtoCommerceMerchandisingModuleWebModelPromotionReward);
        }

        /// <summary>
        /// Returns true if VirtoCommerceMerchandisingModuleWebModelPromotionReward instances are equal
        /// </summary>
        /// <param name="obj">Instance of VirtoCommerceMerchandisingModuleWebModelPromotionReward to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VirtoCommerceMerchandisingModuleWebModelPromotionReward other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
