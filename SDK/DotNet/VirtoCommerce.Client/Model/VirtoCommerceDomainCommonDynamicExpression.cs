...
namespace VirtoCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class VirtoCommerceDomainCommonDynamicExpression :  IEquatable<VirtoCommerceDomainCommonDynamicExpression>
    {
        /// <summary>
        ...
        public VirtoCommerceDomainCommonDynamicExpression(string Id = null, List<VirtoCommerceDomainCommonDynamicExpression> AvailableChildren = null, List<VirtoCommerceDomainCommonDynamicExpression> Children = null)
        {
            this.Id = Id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VirtoCommerceDomainCommonDynamicExpression {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as VirtoCommerceDomainCommonDynamicExpression);
        }

        /// <summary>
        /// Returns true if VirtoCommerceDomainCommonDynamicExpression instances are equal
        /// </summary>
        /// <param name="other">Instance of VirtoCommerceDomainCommonDynamicExpression to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VirtoCommerceDomainCommonDynamicExpression other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
