...
namespace VirtoCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public class VirtoCommerceDomainPricingModelPrice : IEquatable<VirtoCommerceDomainPricingModelPrice>
    {
        ...
        /// </summary>
        /// <param name="obj">Instance of VirtoCommerceDomainPricingModelPrice to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EffectiveValue != null)
                    hash = hash * 57 + this.EffectiveValue.GetHashCode();
