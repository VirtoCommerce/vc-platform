...
namespace VirtoCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public class VirtoCommercePricingModuleWebModelPricelistAssignment : IEquatable<VirtoCommercePricingModuleWebModelPricelistAssignment>
    {
        ...
        /// </summary>
        /// <param name="obj">Instance of VirtoCommercePricingModuleWebModelPricelistAssignment to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CatalogName != null)
                    hash = hash * 57 + this.CatalogName.GetHashCode();
