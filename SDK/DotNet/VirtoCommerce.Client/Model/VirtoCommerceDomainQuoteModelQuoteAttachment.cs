...
namespace VirtoCommerce.Client.Model
{
    ...
    public class VirtoCommerceDomainQuoteModelQuoteAttachment : IEquatable<VirtoCommerceDomainQuoteModelQuoteAttachment>
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VirtoCommerceDomainQuoteModelQuoteAttachment {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as VirtoCommerceDomainQuoteModelQuoteAttachment);
        }

        /// <summary>
        /// Returns true if VirtoCommerceDomainQuoteModelQuoteAttachment instances are equal
        /// </summary>
        /// <param name="obj">Instance of VirtoCommerceDomainQuoteModelQuoteAttachment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VirtoCommerceDomainQuoteModelQuoteAttachment other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
