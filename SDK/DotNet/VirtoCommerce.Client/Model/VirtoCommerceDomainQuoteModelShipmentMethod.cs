...
namespace VirtoCommerce.Client.Model
{
    ...
    public class VirtoCommerceDomainQuoteModelShipmentMethod : IEquatable<VirtoCommerceDomainQuoteModelShipmentMethod>
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VirtoCommerceDomainQuoteModelShipmentMethod {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as VirtoCommerceDomainQuoteModelShipmentMethod);
        }

        /// <summary>
        /// Returns true if VirtoCommerceDomainQuoteModelShipmentMethod instances are equal
        /// </summary>
        /// <param name="obj">Instance of VirtoCommerceDomainQuoteModelShipmentMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VirtoCommerceDomainQuoteModelShipmentMethod other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
