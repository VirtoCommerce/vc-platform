...
namespace VirtoCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public class VirtoCommerceMerchandisingModuleWebModelCatalogItem : IEquatable<VirtoCommerceMerchandisingModuleWebModelCatalogItem>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as VirtoCommerceMerchandisingModuleWebModelCatalogItem);
        }

        /// <summary>
        /// Returns true if VirtoCommerceMerchandisingModuleWebModelCatalogItem instances are equal
        /// </summary>
        /// <param name="obj">Instance of VirtoCommerceMerchandisingModuleWebModelCatalogItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VirtoCommerceMerchandisingModuleWebModelCatalogItem other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
