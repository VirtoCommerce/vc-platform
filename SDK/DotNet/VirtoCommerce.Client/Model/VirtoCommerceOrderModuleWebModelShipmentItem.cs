...
namespace VirtoCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public class VirtoCommerceOrderModuleWebModelShipmentItem : IEquatable<VirtoCommerceOrderModuleWebModelShipmentItem>
    {
        ...
        /// </summary>
        /// <param name="obj">Instance of VirtoCommerceOrderModuleWebModelShipmentItem to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.LineItem != null)
                    hash = hash * 57 + this.LineItem.GetHashCode();
                
                if (this.BarCode != null)
                    hash = hash * 57 + this.BarCode.GetHashCode();
