...
namespace VirtoCommerce.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public class VirtoCommerceCartModuleWebModelSearchResult : IEquatable<VirtoCommerceCartModuleWebModelSearchResult>
    {
        ...
        /// </summary>
        /// <param name="obj">Instance of VirtoCommerceCartModuleWebModelSearchResult to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ShopingCarts != null)
                    hash = hash * 57 + this.ShopingCarts.GetHashCode();
