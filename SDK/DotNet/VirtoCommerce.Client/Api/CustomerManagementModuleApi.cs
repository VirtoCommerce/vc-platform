...
namespace VirtoCommerce.Client.Api
{
    ...
    public interface ICustomerManagementModuleApi
    {
        ...
        /// </remarks>
        /// <param name="id">Contact ID</param>
        /// <returns>VirtoCommerceCustomerModuleWebModelLoginOnBehalfInfo</returns>
        VirtoCommerceCustomerModuleWebModelLoginOnBehalfInfo CustomerModuleGetLoginOnBehalfInfo (string id);
        ...
        /// </remarks>
        /// <param name="id">Contact ID</param>
        /// <returns>ApiResponse of VirtoCommerceCustomerModuleWebModelLoginOnBehalfInfo</returns>
        ApiResponse<VirtoCommerceCustomerModuleWebModelLoginOnBehalfInfo> CustomerModuleGetLoginOnBehalfInfoWithHttpInfo (string id);
        ...
        /// </remarks>
        /// <param name="id">Contact ID</param>
        /// <returns>Task of VirtoCommerceCustomerModuleWebModelLoginOnBehalfInfo</returns>
        System.Threading.Tasks.Task<VirtoCommerceCustomerModuleWebModelLoginOnBehalfInfo> CustomerModuleGetLoginOnBehalfInfoAsync (string id);
        ...
        /// </remarks>
        /// <param name="id">Contact ID</param>
        /// <returns>Task of ApiResponse (VirtoCommerceCustomerModuleWebModelLoginOnBehalfInfo)</returns>
        System.Threading.Tasks.Task<ApiResponse<VirtoCommerceCustomerModuleWebModelLoginOnBehalfInfo>> CustomerModuleGetLoginOnBehalfInfoAsyncWithHttpInfo (string id);
    ...
    public class CustomerManagementModuleApi : ICustomerManagementModuleApi
    {
        ...
        /// <param name="id">Contact ID</param> 
        /// <returns>VirtoCommerceCustomerModuleWebModelLoginOnBehalfInfo</returns>
        public VirtoCommerceCustomerModuleWebModelLoginOnBehalfInfo CustomerModuleGetLoginOnBehalfInfo (string id)
        {
             ApiResponse<VirtoCommerceCustomerModuleWebModelLoginOnBehalfInfo> response = CustomerModuleGetLoginOnBehalfInfoWithHttpInfo(id);
             return response.Data;
        }
        ...
        /// <param name="id">Contact ID</param> 
        /// <returns>ApiResponse of VirtoCommerceCustomerModuleWebModelLoginOnBehalfInfo</returns>
        public ApiResponse< VirtoCommerceCustomerModuleWebModelLoginOnBehalfInfo > CustomerModuleGetLoginOnBehalfInfoWithHttpInfo (string id)
        {
            
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling CustomerManagementModuleApi->CustomerModuleGetLoginOnBehalfInfo");
            
    
            var path_ = "/api/contacts/{id}/loginonbehalf";
            ...
            if (statusCode >= 400)
                throw new ApiException (statusCode, "Error calling CustomerModuleGetLoginOnBehalfInfo: " + response.Content, response.Content);
            else if (statusCode == 0)
                throw new ApiException (statusCode, "Error calling CustomerModuleGetLoginOnBehalfInfo: " + response.ErrorMessage, response.ErrorMessage);
    
            return new ApiResponse<VirtoCommerceCustomerModuleWebModelLoginOnBehalfInfo>(statusCode,
                response.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (VirtoCommerceCustomerModuleWebModelLoginOnBehalfInfo) Configuration.ApiClient.Deserialize(response, typeof(VirtoCommerceCustomerModuleWebModelLoginOnBehalfInfo)));
        ...
        /// <param name="id">Contact ID</param>
        /// <returns>Task of VirtoCommerceCustomerModuleWebModelLoginOnBehalfInfo</returns>
        public async System.Threading.Tasks.Task<VirtoCommerceCustomerModuleWebModelLoginOnBehalfInfo> CustomerModuleGetLoginOnBehalfInfoAsync (string id)
        {
             ApiResponse<VirtoCommerceCustomerModuleWebModelLoginOnBehalfInfo> response = await CustomerModuleGetLoginOnBehalfInfoAsyncWithHttpInfo(id);
             return response.Data;
        ...
        /// <param name="id">Contact ID</param>
        /// <returns>Task of ApiResponse (VirtoCommerceCustomerModuleWebModelLoginOnBehalfInfo)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<VirtoCommerceCustomerModuleWebModelLoginOnBehalfInfo>> CustomerModuleGetLoginOnBehalfInfoAsyncWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null) throw new ApiException(400, "Missing required parameter 'id' when calling CustomerModuleGetLoginOnBehalfInfo");
