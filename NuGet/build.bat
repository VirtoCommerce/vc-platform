...
nuget pack "%SOURCE_DIR%\VirtoCommerce.Platform.Client\VirtoCommerce.Platform.Client.csproj" -IncludeReferencedProjects -Symbols -Properties Configuration=Release -o "%TARGET_DIR%"
