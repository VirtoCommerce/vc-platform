 ...
 */
(function () {
    angular.module('dcbImgFallback', []).directive('fallbackSrc', ['imageService', function (imageService) {
        ...
        var linkFunction = function linkFunction(scope, element, attr) {
        ...
        return {
            ...
            getMissing: function getMissing() {
                return missingDefault;
            },
            setLoading: function setLoading(newSrc) {
                return loadingDefault = newSrc;
            },
            setMissing: function setMissing(newSrc) {
