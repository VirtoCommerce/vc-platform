...
namespace VirtoCommerce.Storefront
{
    public class RouteConfig
    {
        ...
        public static void RegisterRoutes(RouteCollection routes, Func<WorkContext> workContextFactory, ICommerceCoreModuleApi commerceCoreApi, IStaticContentService staticContentService, ICacheManager<object> cacheManager)
        {
            ...
            routes.MapLocalizedStorefrontRoute("API.Common.GetRegions", "storefrontapi/{countryCode}/regions", defaults: new { controller = "ApiCommon", action = "GetRegions" });
            ...
            //Quote requests API
            routes.MapLocalizedStorefrontRoute("API.QuoteRequest.GetItemsCount", "storefrontapi/quoterequest/{number}/itemscount", defaults: new { controller = "ApiQuoteRequest", action = "GetItemsCount" });
            routes.MapLocalizedStorefrontRoute("API.QuoteRequest.Get", "storefrontapi/quoterequest/{number}", defaults: new { controller = "ApiQuoteRequest", action = "Get" });
            routes.MapLocalizedStorefrontRoute("API.QuoteRequest.AddItem", "storefrontapi/quoterequest/{number}/items", defaults: new { controller = "ApiQuoteRequest", action = "AddItem" }, constraints: new { httpMethod = new HttpMethodConstraint(new string[] { "POST" }) });
            routes.MapLocalizedStorefrontRoute("API.QuoteRequest.RemoveItem", "storefrontapi/quoterequest/{number}/items/{itemId}", defaults: new { controller = "ApiQuoteRequest", action = "RemoveItem" }, constraints: new { httpMethod = new HttpMethodConstraint(new string[] { "DELETE" }) });
            routes.MapLocalizedStorefrontRoute("API.QuoteRequest.Update", "storefrontapi/quoterequest/{number}", defaults: new { controller = "ApiQuoteRequest", action = "Update" }, constraints: new { httpMethod = new HttpMethodConstraint(new string[] { "PUT" }) });
            routes.MapLocalizedStorefrontRoute("API.QuoteRequest.Submit", "storefrontapi/quoterequest/{number}/submit", defaults: new { controller = "ApiQuoteRequest", action = "Submit" }, constraints: new { httpMethod = new HttpMethodConstraint(new string[] { "POST" }) });
            routes.MapLocalizedStorefrontRoute("API.QuoteRequest.Reject", "storefrontapi/quoterequest/{number}/reject", defaults: new { controller = "ApiQuoteRequest", action = "RejectJson" }, constraints: new { httpMethod = new HttpMethodConstraint(new string[] { "POST" }) });
            routes.MapLocalizedStorefrontRoute("API.QuoteRequest.CalculateTotals", "storefrontapi/quoterequest/{number}/totals", defaults: new { controller = "ApiQuoteRequest", action = "CalculateTotals" }, constraints: new { httpMethod = new HttpMethodConstraint(new string[] { "POST" }) });
            routes.MapLocalizedStorefrontRoute("API.QuoteRequest.Confirm", "storefrontapi/quoterequest/{number}/confirm", defaults: new { controller = "ApiQuoteRequest", action = "Confirm" }, constraints: new { httpMethod = new HttpMethodConstraint(new string[] { "POST" }) });
