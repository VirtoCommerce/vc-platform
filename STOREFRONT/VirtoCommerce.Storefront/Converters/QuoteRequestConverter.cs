...
namespace VirtoCommerce.Storefront.Converters
{
    ...
    {
        public static QuoteRequest ToWebModel(this VirtoCommerceDomainQuoteModelQuoteRequest serviceModel)
        {
            ...
            {
                webModel.ShipmentMethod = serviceModel.ShipmentMethod.ToWebModel(currency);
            }
