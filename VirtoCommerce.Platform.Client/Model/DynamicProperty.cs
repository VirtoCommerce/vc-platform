...
namespace VirtoCommerce.Platform.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DynamicProperty :  IEquatable<DynamicProperty>
    {
        /// <summary>
        /// Gets or Sets Name
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as DynamicProperty);
        }

        /// <summary>
        /// Returns true if DynamicProperty instances are equal
        /// </summary>
        /// <param name="other">Instance of DynamicProperty to be compared</param>
        /// <returns>Boolean</returns>
