...
namespace VirtoCommerce.Platform.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ModulePushNotification :  IEquatable<ModulePushNotification>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ModulePushNotification {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ModulePushNotification);
        }

        /// <summary>
        /// Returns true if ModulePushNotification instances are equal
        /// </summary>
        /// <param name="other">Instance of ModulePushNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModulePushNotification other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
