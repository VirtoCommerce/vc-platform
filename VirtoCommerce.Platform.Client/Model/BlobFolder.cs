...
namespace VirtoCommerce.Platform.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BlobFolder :  IEquatable<BlobFolder>
    {
        /// <summary>
        /// Gets or Sets Name
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BlobFolder);
        }

        /// <summary>
        /// Returns true if BlobFolder instances are equal
        /// </summary>
        /// <param name="other">Instance of BlobFolder to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BlobFolder other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
