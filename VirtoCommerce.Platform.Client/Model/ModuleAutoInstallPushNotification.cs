...
namespace VirtoCommerce.Platform.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ModuleAutoInstallPushNotification :  IEquatable<ModuleAutoInstallPushNotification>
    {
        /// <summary>
        /// Gets or Sets ProgressLog
        /// </summary>
        [DataMember(Name="progressLog", EmitDefaultValue=false)]
        public List<ProgressMessage> ProgressLog { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ModuleAutoInstallPushNotification {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ModuleAutoInstallPushNotification);
        }

        /// <summary>
        /// Returns true if ModuleAutoInstallPushNotification instances are equal
        /// </summary>
        /// <param name="other">Instance of ModuleAutoInstallPushNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModuleAutoInstallPushNotification other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
