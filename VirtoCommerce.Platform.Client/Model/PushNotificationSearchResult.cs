...
namespace VirtoCommerce.Platform.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PushNotificationSearchResult :  IEquatable<PushNotificationSearchResult>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PushNotificationSearchResult {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PushNotificationSearchResult);
        }

        /// <summary>
        /// Returns true if PushNotificationSearchResult instances are equal
        /// </summary>
        /// <param name="other">Instance of PushNotificationSearchResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PushNotificationSearchResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
