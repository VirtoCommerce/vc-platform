...
namespace VirtoCommerce.Platform.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RoleSearchRequest :  IEquatable<RoleSearchRequest>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RoleSearchRequest {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RoleSearchRequest);
        }

        /// <summary>
        /// Returns true if RoleSearchRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of RoleSearchRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RoleSearchRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
