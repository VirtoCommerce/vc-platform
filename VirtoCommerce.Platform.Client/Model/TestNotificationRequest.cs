...
namespace VirtoCommerce.Platform.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TestNotificationRequest :  IEquatable<TestNotificationRequest>
    {
        /// <summary>
        /// Gets or Sets Type
        /// </summary>
        ...
        public List<NotificationParameter> NotificationParameters { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TestNotificationRequest);
        }

        /// <summary>
        /// Returns true if TestNotificationRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of TestNotificationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TestNotificationRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
