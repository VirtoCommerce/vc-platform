    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        ReportAbuseElementId = c.String(nullable: false, maxLength: 128),
                        Comment = c.String(maxLength: 1024),
                ...
                .PrimaryKey(t => t.ReportAbuseElementId)
                .ForeignKey("dbo.Review", t => t.ReviewId)
                .Index(t => t.ReviewId);
            ...
            CreateTable(
                ...
                c => new
                    {
                        ReportHelpfulElementId = c.String(nullable: false, maxLength: 128),
                ...
                .PrimaryKey(t => t.ReportHelpfulElementId)
                .ForeignKey("dbo.Review", t => t.ReviewId)
                .Index(t => t.ReviewId);
