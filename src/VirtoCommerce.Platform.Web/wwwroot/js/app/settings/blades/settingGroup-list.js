angular.module('platformWebApp').controller('platformWebApp.settingGroupListController', ['$window', 'platformWebApp.modules', '$scope', 'platformWebApp.settings', 'platformWebApp.bladeNavigationService', 'platformWebApp.dialogService', '$timeout',
    function ($window, modules, $scope, settings, bladeNavigationService, dialogService, $timeout) {
    var settingsTree;
