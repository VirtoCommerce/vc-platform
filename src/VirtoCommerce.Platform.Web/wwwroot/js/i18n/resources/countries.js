...
angular.module('platformWebApp')
    .factory('platformWebApp.common.countries', ['$translate', function ($translate) {
        return {
            get: function (id) {
            ...
            query: function () {
                var results = [
                    ...
                    { id: "PLW", name: "Palau" },
                    { id: "PSE", name: "Palestine, State of" },
                    { id: "PAN", name: "Panama" },
                ...
                for (var i = 0; i < results.length; i++) {
                    var translateKey = 'platform.countries.' + results[i].id;
                    var translated = $translate.instant(translateKey);
                    results[i].displayName = translated === translateKey ? results[i].name : translated;
                }
