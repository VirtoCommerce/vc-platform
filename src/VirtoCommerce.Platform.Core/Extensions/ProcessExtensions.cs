...
namespace VirtoCommerce.Platform.Core.Extensions
{
    public static class ProcessExtensions
    {
        ...
        {
            DotNetPath = TryFindDotNetPath();
        }

        public static string DotNetPath { get; }

        public static string DotNetPathOrDefault() => DotNetPath ?? DotNetName;

        public static void StartPlatformProcess(string platformEntryPoint = "VirtoCommerce.Platform.Web.dll")
        {
            var process = new Process
            {
                ...
                StartInfo =
                {
                    FileName = DotNetPathOrDefault(),
                    Arguments = platformEntryPoint,
