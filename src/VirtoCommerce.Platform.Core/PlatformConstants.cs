    ...
    public static class PlatformConstants
    {
        public static class Security
        {
            ...
            public static class Permissions
            {
                ...
                public static string[] AllPermissions { get; set; } = new[] { ResetCache, AssetAccess, AssetDelete, AssetUpdate, AssetCreate, AssetRead, ModuleQuery, ModuleAccess, ModuleManage,
        ...
        public static class Settings
        {
            public static class Security
            {
                public static SettingDescriptor SecurityAccountTypes { get; set; } = new SettingDescriptor
                {
            ...
            {
                public static SettingDescriptor SetupStep { get; set; } = new SettingDescriptor
                {
                ...
                public static SettingDescriptor SampleDataState { get; set; } = new SettingDescriptor
                {
                ...
                public static SettingDescriptor ModulesAutoInstallState { get; set; } = new SettingDescriptor
                {
                ...
                public static SettingDescriptor ModulesAutoInstalled { get; set; } = new SettingDescriptor
                {
            ...
            {
                public static SettingDescriptor MainMenuState { get; set; } = new SettingDescriptor
                {
                    Name = "VirtoCommerce.Platform.UI.MainMenu.State",
                    GroupName = "Platform|User Profile",
                    ValueType = SettingValueType.Json,
                };
                public static SettingDescriptor Language { get; set; } = new SettingDescriptor
                {
                ...
                public static SettingDescriptor RegionalFormat { get; set; } = new SettingDescriptor
                {
                ...
                public static SettingDescriptor TimeZone { get; set; } = new SettingDescriptor
                {
                    Name = "VirtoCommerce.Platform.UI.TimeZone",
                    GroupName = "Platform|User Profile",
                    ValueType = SettingValueType.ShortText
                };
                public static SettingDescriptor UseTimeAgo { get; set; } = new SettingDescriptor
                {
                ...
                public static SettingDescriptor FullDateThreshold { get; set; } = new SettingDescriptor
                {
                    Name = "VirtoCommerce.Platform.UI.FullDateThreshold",
                    GroupName = "Platform|User Profile",
                    ValueType = SettingValueType.Integer,
                };
                public static SettingDescriptor FullDateThresholdUnit { get; set; } = new SettingDescriptor
                {
                ...
                public static SettingDescriptor ShowMeridian { get; set; } = new SettingDescriptor
                {
            ...
            {
                public static SettingDescriptor Customization { get; set; } = new SettingDescriptor
                {
