...
/// <para>
/// Services built on the generic <c>SearchService</c> implement this interface automatically.
/// A service whose <c>SearchAsync</c> uses non-standard search logic must also override
/// <c>SearchAllAsync</c> and <c>CountAllAsync</c> to keep them consistent with it.
/// </para>
/// <para>
