...
Function create-storage
{
    ...
    if($temp_storageaccount -eq $null)
    {
        ...
        New-AzureStorageAccount -StorageAccountName $common_storageaccount -Label $common_storageaccount -Location $region
...
Function deploy-file
{
    ...
    Set-AzureStorageBlobContent -Container $container -File $source -Blob $destination -Verbose -ConcurrentTaskCount 2 -Force   
