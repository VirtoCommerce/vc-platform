...
namespace VirtoCommerce.PowerShell.Customers
{
    public class SqlCustomerDatabaseInitializer : SetupDatabaseInitializer<EFCustomerRepository, Configuration>
    {
        ...
        private void FillCustomerContent(EFCustomerRepository client)
        {
            ...
            contact.Addresses.Add(new Address { Name = "Primary Address", FirstName = "John", LastName = "Doe", City = "Los Angeles", CountryCode = "USA", StateProvince = "CA", CountryName = "United States", Line1 = "8237 Santa Monica Blvd", PostalCode = "90210", DaytimePhoneNumber = "none", Email = "john_doe_work@gmail.com", MemberId = contact.MemberId });
            ...
            contact2.Addresses.Add(new Address { Name = "Primary Address", FirstName = "Bill", LastName = "Ballmer", City = "New York", CountryCode = "USA",StateProvince = "CA", CountryName = "United States", Line1 = "1556 Broadway", PostalCode = "10120", DaytimePhoneNumber = "none", Email = "bb_1965@outlook.com", MemberId = contact2.MemberId });
