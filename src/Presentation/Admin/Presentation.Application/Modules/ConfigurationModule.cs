    ...
    public class ConfigurationModule : IModule
    {
        ...
        public void Initialize()
        {
            ...
            if (HasPermissions())
            {
                ...
                menuNavItem.Caption = "Settings";
                menuNavItem.ItemBackground = Color.FromRgb(132, 94, 178);
                menuNavItem.ImageResourceKey = "Icon_Module_Settings";
                menuNavItem.Order = 110;
        ...
        private void RegisterConfigurationViews()
        {
            ...
            {
                ConfigurationManager.Settings.Add(new ConfigurationSection { Caption = "Search", Order = 20, ViewModel = _container.Resolve<IBuildSettingsViewModel>() });
            }
        }
