...
{
	[Serializable]
	public class ConditionGeoCity : TypedExpressionElementBase, IExpressionAdaptor
	{
		...
		public System.Linq.Expressions.Expression<Func<IEvaluationContext, bool>> GetExpression()
		{
			...
			var propertyValue = System.Linq.Expressions.Expression.Property(castOp, typeof(PriceListAssignmentEvaluationContext).GetProperty("GeoCity"));
