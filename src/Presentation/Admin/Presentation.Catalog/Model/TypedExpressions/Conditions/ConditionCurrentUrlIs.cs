...
namespace VirtoCommerce.ManagementClient.Catalog.Model.TypedExpressions.Conditions
{
	...
	public class ConditionCurrentUrlIs : TypedExpressionElementBase, IExpressionAdaptor
	{
		...
		public ConditionCurrentUrlIs(IExpressionViewModel expressionViewModel)
			: base("Currently viewed Url []".Localize(), expressionViewModel)
		{
			WithLabel("Current Url ".Localize());
		...
		public linq.Expression<Func<IEvaluationContext, bool>> GetExpression()
		{
			...
			var propertyValue = linq.Expression.Property(castOp, typeof(PriceListAssignmentEvaluationContext).GetProperty("CurrentUrl"));
