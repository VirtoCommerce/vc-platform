angular.module('catalogModule.blades.propertyAttributes', [])
.controller('propertyAttributesController', ['$scope', '$filter', 'dialogService', function ($scope, $filter, dialogService) {
