...
.controller('importJobListController', ['$scope', 'bladeNavigationService', 'dialogService', 'imports', function ($scope, bladeNavigationService, dialogService, imports) {
    ...
    $scope.edit = function (listItem) {
        ...
        var newBlade = {
            ...
            template: 'Modules/$(VirtoCommerce.Catalog)/Scripts/app/catalog/wizards/importWizard/import-job-wizard.tpl.html'
        };
    ...
    $scope.run = function (listItem) {
        ...
        var newBlade = {
            ...
            template: 'Modules/$(VirtoCommerce.Catalog)/Scripts/app/catalog/blades/import/import-job-run.tpl.html'
        };
        bladeNavigationService.showBlade(newBlade, $scope.blade);
    };
