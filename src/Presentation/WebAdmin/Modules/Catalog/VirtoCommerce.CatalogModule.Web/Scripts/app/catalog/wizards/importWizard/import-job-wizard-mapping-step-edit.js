angular.module('catalogModule.wizards.importJobWizard.mapping.edit', [
])
.controller('importJobMappingEditController', ['$scope', 'bladeNavigationService', function ($scope, bladeNavigationService)
{
