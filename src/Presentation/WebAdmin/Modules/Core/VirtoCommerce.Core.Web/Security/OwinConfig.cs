...
namespace VirtoCommerce.CoreModule.Web.Security
{
	public class OwinConfig
	{
		...
		public static void Configure(IAppBuilder app, Func<ISecurityRepository> securityRepositoryFactory)
		{
			...
			{
				ApiCredentialsProvider = new ApiAccountProvider(securityRepositoryFactory),
				IdentityProvider = new ApplicationClaimsIdentityProvider(),
			});
		}
	}
}
