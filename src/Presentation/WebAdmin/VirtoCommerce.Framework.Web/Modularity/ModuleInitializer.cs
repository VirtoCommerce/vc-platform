...
namespace VirtoCommerce.Framework.Web.Modularity
{
    ...
    public class ModuleInitializer : IModuleInitializer
    {
        ...
        public virtual void HandleModuleInitializationError(ModuleInfo moduleInfo, string assemblyName, Exception exception)
        {
            ...
            this.loggerFacade.Error(moduleException.ToString());
        ...
        protected virtual IModule CreateModule(string typeName)
        {
            ...
            if (moduleType == null)
            {
                throw new ModuleInitializeException(string.Format(CultureInfo.CurrentCulture, VirtoCommerce.Framework.Web.Properties.Resources.FailedToGetType, typeName));
            }
